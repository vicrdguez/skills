...
- If the user names a superseded slug or its closed issue, read that issue, the PR's audit ledger and review findings, and the abandoned artifacts before drafting. The failed attempt is evidence: the new slice must not re-derove what it already proved wrong.
