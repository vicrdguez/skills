...
ledger:
  ...
  decision:
    commit: 0000000000000000000000000000000000000007
    path: projects/widgets/proposals/widget-dashboard/foundation/decision.md
---
...
Reference: `0000000000000000000000000000000000000005:projects/widgets/proposals/widget-dashboard/foundation/decision.md`
...
answered_request:
  commit: 0000000000000000000000000000000000000010
  path: projects/widgets/proposals/widget-dashboard/foundation/watchdog-report.md
route: implement
---
# Human direction
...
No available ancestral previous reviewed revision exists, so review the complete comparison from the recorded Integration Target and examine every Contract Item. The completed-review count (2) and every prior `W<n>` finding identity are retained exactly; starting, resuming, or falling back to a full review never resets or advances either.
...
`skl skill --resource reference/ledger-review.md --input result_directory='/tmp/skl-watchdog-result' --input round=3 --input reviewed_head='0000000000000000000000000000000000000002' watchdog`
