...
`skl skill --resource ledger-review.md --input result_directory='/tmp/skl-watchdog-result' --input round=3 --input reviewed_head='0000000000000000000000000000000000000002' watchdog`
