...
4. Review `git diff 0000000000000000000000000000000000000004...HEAD` as a repeat review. Apply the method and criteria below. Review against the recorded Integration Target, this round's cutoff: the merge and its conflict resolutions count, unrelated inherited target code does not.
