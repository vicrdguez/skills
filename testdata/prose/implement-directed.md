...
```
`0000000000000000000000000000000000000004:projects/widgets/proposals/widget-dashboard/foundation/watchdog-report.md`
...
```
`0000000000000000000000000000000000000004:projects/widgets/proposals/widget-dashboard/foundation/decision.md`
...
If the fetch fails, use the last target preparation or inspection reported, or the recorded target `0000000000000000000000000000000000000003`, as `<observed-target-sha>`, and record the evidence as local-only. When a conflict needs a consequential choice, pause. When `main` moves later, keep the cutoff.
