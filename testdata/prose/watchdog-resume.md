...
# Watchdog review of `widget-dashboard/foundation` (resumed)
...
`skl skill --resource reference/ledger-review.md --input result_directory='/tmp/skl-watchdog-result' --input round=1 --input reviewed_head='0000000000000000000000000000000000000002' watchdog`
