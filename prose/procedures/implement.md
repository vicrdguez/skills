...
{{else if eq .Capability "sequential"}}The invocation established that no supported helper-launch mechanism is available. Perform implementation and testing subwork serially as the owner.
